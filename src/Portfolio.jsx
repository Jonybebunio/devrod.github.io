...
function Portfolio() {
  ...
  const projectData = [
    ...
    { 
      ...
      description: 'ACOC es una asociación cultural en Orihuela Costa.',
      platform: 'Ionos',
    ...
    { 
      ...
      description: 'Es un chatbot automatizado para responder a los clientes el menú del restaurante.',
